  ...
  useEffect(() => {
    ...
    if (!toggle) {
      ...
      tl
        ...
        .to(maskRef, 0.8, { opacity: 0, ease: Power4.easeInOut }, "-=.5")
        .to(selectedCardA, 0.2, { opacity: 1 }, "-=0")
        .to(selectedCardA, 0.2, { opacity: 0 }, "-=0")
        .to(selectedCardB, 0.3, { opacity: 1 }, "-=.2")
        .to(selectedCardB, 0.3, { opacity: 0 }, "-=0")
        .to(selectedCardC, 0.4, { opacity: 1 }, "-=.3")
        .to(selectedCardC, 0.4, { opacity: 0 }, "-=0")
        .to(selectedCardD, 0.5, { opacity: 1 }, "-=.4");
    }
  }, [toggle]);
  return (
    ...
    >
      ...
      <g filter="url(#grid-icon-shadow)">
        <rect
          ...
          x="50"
        />
        <rect className="st1" width="130" height="130" y="220" x="50" />
        <rect className="st1" width="130" height="130" x="220" y="50" />

        <rect className="st1" width="130" height="130" y="220" x="220" />
        <rect
      ...
      <path
        fill="#828282"
        d="M0 0v400h400V0H0zm180.33 353.67h-134v-134h134v134zm0-173.34h-134v-134h134v134zm173.34 173.34h-134v-134h134v134zm0-173.34h-134v-134h134v134z"
