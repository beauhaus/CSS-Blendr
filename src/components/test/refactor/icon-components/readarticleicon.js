...
const ReadArticleIcon = (props) => {
    ...
    useEffect(() => {
        gsap.set(pageTurn, { opacity: 0, attr: { points: "300,60 340,30 560,25 520,345 340,340 300,370" }})
        ...
        tl
            .to(pageTurn, .1, { opacity: 1, fill: '#ddd' })
            .to(pageTurn, .05, { attr: { points: "300,60 340,30 560,25 520,345 340,340 300,370" } })
            .to(pageTextRt, .1, { opacity: 1 }, '-=.1')
            .to(pageTurn, .1, { attr: { points: "300,60 360,20 400,0 380,350 340,340 300,370" } })
            .to(pageTurn, .05, { attr: { points: "330,30 330,30 250,0 140,350 230,360 300,370" } })
            .to(pageTurn, .05, { attr: { points: "300,50 230,20 100,10 100,350 180,360 300,370" } })
            .to(pageTurn, .05, { attr: { points: "300,60 260,25 70,20 100,350 240,340 300,370" } })
            .to(pageTurn, .05, { attr: { points: "300,60 260,30 60,30 60,340 260,340 300,370" } })
            .to(pageTextLt, .15, { opacity: 1 })
            .to(pageTurn, .25, { opacity: 0 }, '-=.25')
    }, [mixMode]);
    return (
