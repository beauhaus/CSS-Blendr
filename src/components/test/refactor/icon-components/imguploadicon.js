  ...
  useEffect(() => {
    ...
    if (!usrImgMode) {
      tl.to(
        cloudRef,
        0,
        { y: 0, fillOpacity: 0, ease: "Elastic.easeInOut(1.2, .5)" },
        "-=0"
      )
        .to(
          cloudRef,
          0.5,
          { y: -350, ease: "Elastic.easeInOut(1.2, .5)" },
          "-=0"
        )
        .to(plusRef, 0.4, { opacity: 1 }, "-=.4")
        .to(
          plusRef,
          0.4,
          {
            attr: {
              points:
                "280,40 320,40 320,80 360,80 360,120 320,120 320,160 280,160 280,120 240,120 240,80 280,80",
            },
        ...
        .to(
          mtnRef,
          0.4,
          { x: 0, y: 0, scaleX: 1, ease: Power4.easeInOut },
          "-=.4"
        );
    } else if (usrImgMode) {
      tl.to(
        mtnRef,
        0.7,
        { x: -600, y: 400, scaleX: 2, ease: Power4.easeInOut },
        "-=0"
      )
        .to(
          plusRef,
          0.4,
          {
            attr: {
              points:
                "200,160 200,160 240,200 280,240 280,240 240,240 240,320 160,320 160,240 120,240 120,240 160,200",
            },
            ease: Power4.easeInOut,
          },
          "-=.5"
        )
        .to(cloudRef, 0.4, { y: 0, ease: "Elastic.easeInOut(1.2, .5)" }, "-=.3")
        .to(plusRef, 0.3, { opacity: 0 }, "-=.1")
        .to(cloudRef, 0.2, { fillOpacity: 1 }, "-=.2");
    }
  }, [usrImgMode]);
