...
const FlipImageBtn = () => {
    ...
    return (
        ...
        >
            <svg xmlns="http://www.w3.org/2000/svg" className="scrn-line-grid" width="100%" viewBox="0 0 300 300" preserveAspectRatio="none">
                <g className="lines">
             ...
             {(selBot && selTop)&&<FlipImagePairs className="flip-img-pairs" />}
        </StyledFlipImageBtn>
    )
};
...
//             <svg xmlns="http://www.w3.org/2000/svg" className="scrn-line-grid" width="100%" height="90%" viewBox="0 0 300 300" preserveAspectRatio="none">
//                     <g className="lines">
//                     <path d="M37.5 0v300" className="st1" />
//                     <path d="M74.5 0v300" className="st1" />
//                     <path d="M111.5 0v300" className="st1" />
