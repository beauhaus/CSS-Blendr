...
const SwitchImgIcon = () => {
    ...
    useEffect(() => {
        ...
        addImageMode ?
            tl.to(switchIconCross, { duration: .5, ease: Power1.easeInOut, rotate: 135, attr: { stroke: 'var(--active-blue)' } }, '-=0')
            //    .to(switchIconFrame, { duration: .5, ease: Power1.easeInOut, opacity: 1, attr: { stroke: 'var(--active-blue)' } }, '-=.2')
            :
            tl
        ...
        <StyledSwitchImgIcon className="image-switch-icon" >
            <svg className="image-switch-icon" viewBox="0 0 300 300" width="100%" height="100%" >  
                <filter id="cross-shadow">
                    ...
                    />
                <path ref={elem => switchIconFrame = elem} id="frame" fill="var(--active-blue)" stroke="var(--active-blue)" strokeWidth="1.5" d="M250 4c25.41 0 46 20.59 46 46v200c0 25.41-20.59 46-46 46H50c-25.41 0-46-20.59-46-46V50C4 24.59 24.59 4 50 4h200m0-4H50C22.43 0 0 22.43 0 50v200c0 27.57 22.43 50 50 50h200c27.57 0 50-22.43 50-50V50c0-27.57-22.43-50-50-50z" />
            </svg>
        </StyledSwitchImgIcon>
    )
}
