...
const StyledCustomNavBG = styled.svg`
    width: 100%;
    height: 100%;
    position: absolute;
    top: 0;
...
const CustomNavBG = () => {
    return (
        <StyledCustomNavBG className="custom-nav-bg" viewBox="0 0 900 300" width="100%" height="100%" preserveAspectRatio="none">
