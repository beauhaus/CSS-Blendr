...
const ImageAddIcon = () => {
    ...
    return (
        <StyledImageAddIcon viewBox="0 0 300 300" width="100%" height="100%" preserveAspectRatio="none">
                ...
                <path fill="var(--active-blue);" d="M267.74 54.59h-23.16V31.43c0-2.93-2.37-5.3-5.3-5.3h-16.5c-2.93 0-5.3 2.37-5.3 5.3v23.16h-23.16c-2.93 0-5.3 2.37-5.3 5.3v16.5c0 2.93 2.37 5.3 5.3 5.3h23.16v23.16c0 2.93 2.37 5.3 5.3 5.3h16.5c2.93 0 5.3-2.37 5.3-5.3V81.7h23.16c2.93 0 5.3-2.37 5.3-5.3V59.9c0-2.93-2.37-5.31-5.3-5.31z" />
                <path fill="none" stroke="var(--active-blue);"  strokeWidth="5" d="M1.91 153.65l74.3-87.66 103.73 134.58 60.28-54.67 61.69 84.11" />
