...
const CycleBtnWrapper = styled.svg`
    margin: auto;
    height: 100%;
    width: 100%;
    ${'' /* border:1px dashed blue; */}
    .blend-inc{opacity:1;fill:var(--power-off)}
    #inc1, #inc2, #inc3 {
      fill: var(--power-on);
      stroke: var(--power-on);
      stroke-width: 3;
...
const CycleBtn = () => {
    ...
    return (
        <CycleBtnWrapper className="cycle-btn-svg" xmlns="http://www.w3.org/2000/svg" viewBox="60 40 300 300" >
